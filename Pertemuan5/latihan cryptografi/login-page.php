              ...
              <button type="button" class="btn-close btn-light" data-bs-dismiss="modal" aria-label="Close"></button>
                ...
                <form action="index.php" method="POST">
                    ...
                    <button type="submit" name="submit" class="btn btn-light mt-3" value="login">LOGIN</button>
                        <p>Pengguna Baru? <a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal2">Daftar Sekarang</a></p>
                        </form>
                    </div>
            </div>
            </div>
            ...
            <div class="modal-body">
              <button type="button" class="btn-close btn-light" data-bs-dismiss="modal" aria-label="Close"></button>
                ...
                <form action="register_process.php" method="POST">
                    ...
                    <button type="submit" name="submit" class="btn btn-light mt-3" value="login">REGISTER</button>
                        <p>Sudah Punya Akun? <a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal">Login</a></p>
                        </form>
                    </div>
            </div>
            </div>
